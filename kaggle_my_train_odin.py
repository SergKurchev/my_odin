...
train_cmd = [
    ...
    # NaN RECOVERY (автоматическое восстановление при NaN)
    "--nan_recovery",          # Включить автоматическое восстановление
    "--nan_lr_scale", "0.1",   # Уменьшить LR в 10 раз при NaN
    "--nan_recovery_iters", "100",  # Восстанавливать LR за 100 итераций
    ...
    "--lr", "0.00001",          # Снижен с 0.00005 до 0.00001 для стабильности (NaN на iter 2580)
    "--warmup_ratio", "0.1",    # 10% warmup для стабильности (постепенное увеличение LR)
